              ...
              <Modal show={showOne} onHide={handleCloseOne} size="lg">
                ...
                <Modal.Body>
                  ...
                  <p>
                    ...
                    inactive contacts. Additionally, the application keeps track
                    of sent messages between contacts, and allows the user to
                    add notes detailing conversations. The objective of this
                    application is to create a cohesive space where the user can
                    maintain record of contacts and conversations to avoid
                    overlap, and allow collaboration.
                  </p>
                </Modal.Body>
                <Modal.Footer>
                  <hr></hr>
