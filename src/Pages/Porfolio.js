            ...
            <Modal show={showOne} onHide={handleCloseOne} size="lg">
              ...
              <Modal.Body>
                ...
                <p>
                  ...
                  employees of an orginization. It allows the user to create new
                  contacts, keep track of existing contacts, and stale inactive
                  contacts. Additionally, the application keeps track of sent
                  messages between contacts, and allows the user to add notes
                  detailing conversations. The objective of this application is
                  to create a cohesive space where the user can maintain record
                  of contacts and conversations to avoid overlap, and allow
                  collaboration.
                </p>
              </Modal.Body>
              <Modal.Footer>
          ...
          <Card className="project2">
            ...
            <Modal show={showFive} onHide={handleCloseFive} size="lg">
              ...
              <Modal.Body>
                ...
                <p>
                  This is application allows the user to save different tasks
                  and events by the hour of the day.
                </p>
              </Modal.Body>
              <Modal.Footer>
                <hr></hr>
